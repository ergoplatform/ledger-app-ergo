...
from helpers.data import ADDRESS_0, ADDRESS_1, CHANGE_ADDRESS_22, NETWORK, TX_ID
from helpers.tx_builder import TxBuilder
from helpers.nav_helper import confirm_approve

def test_can_sign_tx_change22(device: Device, backend: BackendInterface, scenario_navigator: NavigateWithScenario, navigator: Navigator) -> None:
    FROM    = ADDRESS_0
    TO      = ADDRESS_1
