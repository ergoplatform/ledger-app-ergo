...
from helpers.data import ADDRESS_0, ADDRESS_SCRIPT, CHANGE_ADDRESS, NETWORK, TX_ID
...
def test_can_blind_sign_tx(device: Device, backend: BackendInterface, scenario_navigator: NavigateWithScenario, navigator: Navigator) -> None:
    FROM    = ADDRESS_0
    TO      = ADDRESS_SCRIPT
