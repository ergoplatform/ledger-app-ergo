...
from helpers.data import ADDRESS_0, ADDRESS_1, AUTH_TOKEN, CHANGE_ADDRESS_22, NETWORK, TX_ID
...
def test_can_sign_tx_change22_with_auth_token(device: Device, backend: BackendInterface, scenario_navigator: NavigateWithScenario, navigator: Navigator) -> None:
    FROM    = ADDRESS_0
    TO      = ADDRESS_1
    CHANGE  = CHANGE_ADDRESS_22
