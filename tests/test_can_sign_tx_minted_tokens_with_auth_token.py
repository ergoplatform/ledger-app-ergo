...
def test_can_sign_tx_minted_tokens_with_auth_token(device: Device, backend: BackendInterface, scenario_navigator: NavigateWithScenario, navigator: Navigator) -> None:
    FROM        = ADDRESS_0
    TO          = ADDRESS_1
    ...
    builder.output(TO, 100000000, None, 1000)
    builder.fee(1000000)
